...
export default function Page() {
  return <main className="contact-v1-page">
    ...
    <section className="contact-v1-section contact-v1-support-section"><div className="contact-v1-shell"><div className="contact-v1-section-head"><div><p className="contact-v1-eyebrow">02 / GÜVENLİ BAŞLANGIÇ</p><h2>Az veri paylaşın, doğru yanıtı alın.</h2></div><Link href="/guven-merkezi" className="contact-v1-inline-link">Güven Merkezi’ni incele →</Link></div><div className="contact-v1-support-grid"><div className="contact-v1-never-share"><header><span>ASLA PAYLAŞMA</span><b>KAPSAM DIŞI</b></header><ul><li>Hesap veya uygulama şifresi</li><li>SMS doğrulama kodu</li><li>Kart PIN’i, CVV veya ekran erişimi</li></ul><p>İlk değerlendirme için işlem türü ve yaklaşık tutar yeterlidir. Bu bilgiler istenirse görüşmeyi durdurun.</p></div><div className="contact-v1-faq-panel"><div className="contact-v1-faq-title"><p className="contact-v1-eyebrow">KISA CEVAPLAR</p><strong>İletişimden önce bilmeniz gerekenler</strong><Link href="/sss">Tüm SSS →</Link></div><div className="contact-v1-faqs">{faqs.map(([question, answer]) => <details key={question}><summary>{question}<b>+</b></summary><p>{answer}</p></details>)}</div></div></div></div></section>
