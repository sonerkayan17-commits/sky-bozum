...
const highlights: readonly Highlight[] = [
  {
    ...
    visual: 'codes',
    artwork: [
      { src: '/brands/hero/razer.webp', label: 'Razer Gold', className: 'experience-logo--razer' },
      { src: '/brands/apple/apple.svg', label: 'Apple', className: 'experience-logo--apple' },
      { src: '/brands/hero/steam.webp', label: 'Steam', className: 'experience-logo--steam' },
    ],
  ...
  },
  {
    ...
    visual: 'operators',
    artwork: [
      { src: '/brands/hero/turkcell.webp', label: 'Turkcell' },
      { src: '/brands/hero/vodafone.webp', label: 'Vodafone' },
      { src: '/brands/hero/turk-telekom.webp', label: 'Türk Telekom' },
    ],
  ...
  },
  {
    ...
    visual: 'wallets',
    artwork: [
      { src: '/brands/hero/paycell.webp', label: 'Paycell' },
      { src: '/brands/hero/pokus.webp', label: 'Pokus' },
      { src: '/brands/hero/vodafone.webp', label: 'Vodafone Pay' },
    ],
  ...
  },
  {
    ...
    visual: 'editorial',
    cover: '/images/home/editorial/sky-operator-mobile-payment-guide-v3.webp',
  ...
  },
  {
    ...
    visual: 'editorial',
    cover: '/images/home/editorial/sky-trusted-mobile-site-guide-v3.webp',
  ...
  },
  {
    ...
    visual: 'editorial',
    cover: '/images/home/editorial/sky-fake-mobile-site-warning-v3.webp',
