...
const highlights: readonly Highlight[] = [
  ...
  {
    service: 'Turkcell, Vodafone, Türk Telekom Mobil Bozdurma Rehberi',
    tag: 'Operatör rehberi',
    quote: 'Mobil ödeme ile dijital kod alırken limit, onay ve güvenli kullanım adımlarını öğrenin.',
    accent: 'gold',
