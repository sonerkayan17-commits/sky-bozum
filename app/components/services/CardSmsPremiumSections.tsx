        ...
        <div className={`overflow-hidden rounded-[28px] border ${item.panel}`}>
          <div className="grid lg:grid-cols-[.82fr_1.18fr]">
            <div className="border-b border-white/8 p-7 sm:p-9 lg:border-b-0 lg:border-r">
              ...
              <Link href="/iletisim#guvenlik" className={`focus-ring mt-6 inline-flex rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-xs font-extrabold text-slate-200 ${item.border}`}>Güvenlik kontrolünü açın</Link>
            </div>
