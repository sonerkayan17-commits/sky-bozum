...
import { calculatePayout, getRateByName, parseTurkishAmount, rateDisclaimer, rateItems, validateAmount } from '../lib/rates';
...
export default function Calculator({ embedded = false }: { embedded?: boolean }) {
  ...
  return <section id="oran-hesapla" className="content-shell scroll-mt-24 py-14 sm:py-20" aria-labelledby="calculator-title">
    ...
    <div className="premium-card mx-auto mt-10 max-w-6xl overflow-hidden"><div className="grid xl:grid-cols-[1.12fr_.88fr]">
      ...
      <p className="mt-3 text-center text-[11px] leading-5 text-slate-500">Bu düğme işlem başlatmaz; seçiminizi ve yaklaşık sonucu WhatsApp mesajına hazırlar.</p></div>
