...
export const products: ProductItem[] = [
  {
    ...
    tone: 'pubg',
    coverImage: '/products/pubg-mobile-uc-cover.webp',
    coverLabel: 'PUBG',
    coverNote: 'MOBILE UC',
  ...
  },
  {
    ...
    tone: 'valorant',
    coverImage: '/products/valorant-vp-cover.webp',
    coverLabel: 'VALORANT',
    coverNote: 'POINTS',
  ...
  },
  {
    ...
    tone: 'lol',
    coverImage: '/products/league-of-legends-rp-cover.webp',
    coverLabel: 'LEAGUE',
  ...
  },
  {
    ...
    tone: 'metin2',
    coverImage: '/products/metin2-ejder-parasi-cover.webp',
    coverLabel: 'METİN2',
  ...
  },
  {
    ...
    tone: 'razer',
    coverImage: '/products/razer-gold-cover.webp',
    coverLabel: 'RAZER',
