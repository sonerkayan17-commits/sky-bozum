...
const checks = [
  ...
  ['Reduced motion disables autoplay', hero.includes("matchMedia('(prefers-reduced-motion: reduce)'") && hero.includes('if (paused || reducedMotion) return;')],
  ...
  ['Visible next/previous buttons and dots exist', hero.includes('hero-reference-controls') && hero.includes('hero-reference-dots')],
